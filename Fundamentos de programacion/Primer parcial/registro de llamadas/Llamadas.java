...
public class Llamadas {
    public static void main(String[] args){
        ...
        if (minutos<=5){
            ...
            costo= (5) + (1.6) + (minutos-7)*0.7; 
        } else if (minutos>10){ 
            costo= (5) + (1.6) + (2.1) + (minutos-10)*0.5; 
        }
        System.out.print("Intoduzca el dia de la semana (Número): ");
        int dia = sc.nextInt();
        if (dia==7) {
            costo=costo*1.03;
        } else if (dia>=1 && dia<=5){
            System.out.println("En que horario se realizo la llamada? (1) Matutino (2) Vespertino");
